...
const PostNew = () => {
  ...
  const getWards = async (id) => {
    ...
    try {
      await axios
        .get(`${locationURL}/districts/${id}/wards`)
  ...
  const uploadNewPost = async (postData) => {
    ...
    try {
      const response = await axios.post(`${postsURL}/upload`, postData, {
        headers: config,
      });
  ...
  return (
    <div className="flex flex-col row-start-1 row-span-7 col-start-3 col-span-6 ml-5">
      <div className="py-4 mt-6 border-b border-gray rounded-md h-fit font-bold text-3xl">
        Đăng tin mới
      </div>

      <form onSubmit={handleSubmit} className="my-10 mr-10">
        <div className="my-8">
          <p className="[font-family:'Poppins-Medium',Helvetica]  font-bold text-black text-lg">
            Dịch vụ
          </p>
          <div className="items-center mt-8">
            <label
              className="mb-2 block w-full  [font-family:'Poppins-Medium',Helvetica] font-bold text-black "
              htmlFor="service"
            >
              Gói dịch vụ
            </label>
            ...
            <select
              name="service"
              id="service"
              className="px-3 block text-sm w-full h-10 outline-none rounded-[4px] border border-solid border-[#cccccc]"
            >
        ...
        <div className="my-8">
          ...
          <div className="flex justify-between">
            <div className="items-center mt-8 w-full mr-4">
              ...
              <input
                className="px-3 text-sm block w-full h-10 outline-none rounded-[4px] border border-solid border-[#cccccc]"
                type="text"
            ...
            <div className="items-center mt-8 w-full ml-4">
              ...
              {/* <input className="px-3 block w-full h-10 outline-none rounded-[4px] border border-solid border-[#cccccc]" type="text" defaultValue="" id="service" name="service"/> */}
              <select
                onChange={(e) => getWards(e.target.value)}
                name="district"
                id="district"
                className="px-3 text-sm block w-full h-10 outline-none rounded-[4px] border border-solid border-[#cccccc]"
              >
          ...
          <div className="flex justify-between">
            ...
            <div className="items-center mt-8 w-full mx-4">
              ...
              <input
                className="px-3 block w-full h-10 outline-none rounded-[4px] border border-solid border-[#cccccc]"
                type="text"
                defaultValue=""
                id="street"
                name="street"
          ...
          <div className="flex justify-between">
            <div className="items-center mt-8 w-full">
              <label
                className="mb-2 block text-sm w-full [font-family:'Poppins-Medium',Helvetica] font-bold text-black "
          ...
          <div className="flex justify-between mt-8">
            ...
            <div className="bg-[#E9DDBF] w-full h-72 ml-4 p-6">
              <p className=" mb-2 font-bold text-lg">Lưu ý khi đăng tin</p>
              <p>* Nội dung phải viết bằng tiếng Việt có dấu.</p>
              <p>* Tiêu đề tin không dài quá 100 ký tự.</p>
              <p>
        ...
        <div className="my-8">
          ...
          <div className="flex justify-between">
            <div className="items-center mt-8 w-full">
              ...
              <textarea
                className="p-3 block w-full h-60 outline-none rounded-[4px] border border-solid border-[#cccccc]"
                type="text"
                defaultValue=""
                id="desc"
                name="desc"
          ...
          <div className="flex justify-between">
            ...
            <div className="items-center mt-8 w-full ml-4"></div>
          </div>
        </div>
        ...
        <div className="my-8">
          ...
          <div className="flex justify-between">
            <div className="items-center mt-8 w-full mr-4">
              <p className="mb-2 block w-full [font-family:'Poppins-Medium',Helvetica] font-bold text-black ">
                Cập nhật hình ảnh cho nơi thuê
              </p>
              <div className="h-60 rounded-[4px] border border-dashed border-[#cccccc] justify-center items-center flex">
                <label
                  href=""
                  className="rounded-[4px] border border-solid border-[#cccccc] p-2 cursor-pointer"
                  htmlFor="images"
                >
                  Thêm hình ảnh
                </label>
                <input
                  className="rounded-[4px] border border-solid border-[#cccccc] p-2 hidden"
                  id="images"
                  ...
                  ? images.files.map((image, idx) => {
                      return (
                        <img
                          ...
                          key={idx}
                          alt={'image' + idx}
                          className="images w-48 inline-block pr-3 pt-3"
                        />
                      );
                    })
                  : 'Chưa có ảnh được chọn'}
      ...
      <button className="justify-center items-center rounded-md px-3 py-3 mt-8 mb-16 bg-[#008000]">
        <p className=" text-white text-lg font-semibold">Tạo mới</p>
      </button>
    </div>
  );
    // <div>
