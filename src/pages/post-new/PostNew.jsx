      ...
      <div className="grid grid-cols-8 gap-3 max-w-[1536px] mx-auto">
        ...
        <div className="flex flex-col row-start-1 row-span-7 col-start-3 col-span-6 ml-5">
          ...
          <form onSubmit={handleSubmit} className="my-10 mr-10">
            <div className="my-8">
              <p className="[font-family:'Poppins-Medium',Helvetica] font-medium text-black text-4xl">
                Dịch vụ
              </p>
              <div className="items-center mt-8">
                <label
                  className="mb-2 block w-full [font-family:'Poppins-Medium',Helvetica] font-medium text-black text-[24px]"
                  htmlFor="service"
                >
                  Gói dịch vụ
                </label>
                ...
                <div className="bg-[#E9DDBF] w-full h-72 ml-4 p-6">
                  ...
                  <p>
                    * Để tăng độ tin cậy và tin rao được nhiều người quan tâm
                    ...
                    kéo icon tới đúng vị trí tin rao.
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="my-8">
              ...
              <div className="flex justify-between">
                <div className="items-center mt-8 w-full mr-4">
                  <p className="mb-2 block w-full [font-family:'Poppins-Medium',Helvetica] font-medium text-black text-[24px]">
          ...
          <button className="justify-center items-center rounded-md px-3 py-3 mt-8 mb-16 bg-[#008000]">
            <p className=" text-white text-3xl font-semibold">Tạo mới</p>
          </button>
        </div>
      </div>
      <Footer></Footer>
